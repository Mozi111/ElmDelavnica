	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Nejc je na delavnici s Tjaso!\n In kako je ustvarjalen! Nejc namreč.')
					])),
				A2(
				$elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromInt(model.value) + ' je najino najljubse stevilo')
					])),
				A2(
				$elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromInt(model.numberOfClicks) + '-krat sva si premislila')
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$App$Initialize)
							]))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Nazaj na zacetek')
					]))
			]));
};
